<div wire:init="loadRecentlyReviewed" class="recently-reviewed-container space-y-12 my-8">
    ...
    @empty
        @foreach (range(1, 3) as $game)
            <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
                <div class="relative flex-none">
                    <div class="bg-gray-700 w-32 h-40 lg:w-44 lg:h-56 rounded"></div>
                </div>
                ...
                <span class="text-transparent bg-gray-700 rounded inline-block">
                    Be honorable for whoever disappears, because each has been received with
                </span>
                        <span class="text-transparent bg-gray-700 rounded inline-block">
                    Be honorable for whoever disappears, because each has been received with
                </span>
